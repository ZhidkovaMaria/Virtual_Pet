...
* Возможность выбора имени питомцу
* Интерактивные механики взаимодействия
* Просмотр и экспорт статистики и достижений
* Взаимодействие пользователя с питомцем
* Регистрация пользователя и управление аккаунтом
* Возможность набирать баллы и делиться ими с другими
* Возможность выбора пользователем начального персонажа
* Напоминание пользователю об отсутствии активности за установленное время
